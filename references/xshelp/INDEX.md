...
| 分類 | 檔案 | 項目數 | 內容 |
|---|---|---|---|
| 關鍵字-忽略字 | SKIPWORD.md | 15 | 忽略字總覽、A、An、At、Based、By、Does、From …共15項 |
| 關鍵字-常數 | CONSTANT.md | 9 | 常數總覽、Friday、Monday、PI、Saturday、Sunday、Thursday、Tuesday …共9項 |
| 關鍵字-流程控制 | CONTROLFLOW.md | 45 | 流程控制總覽、IF / THEN / ELSE、Switch / Case / Default、Once、For To / DownTo、While、Repeat / Until、Break …共45項 |
| 關鍵字-宣告 | DECLARATION.md | 50 | 宣告總覽、Var、IntrabarPersist、Array、Input、inputkind、Numeric、NumericRef …共50項 |
...
| 內建函數-SDT共享資料表 | SDT.md | 38 | SDT_Average、SDT_Average_L、SDT_GetKeys、SDT_GetKeys_L、SDT_GetString、SDT_GetString_L、SDT_GetValue、SDT_GetValue_L …共38項 |
...
| 資料欄位-基本 | TBASIC.md | 11 | 月營收、本益比、投資建議評級、股本(元)、股本(億)、財報股本(億)、殖利率、發行張數(張) …共11項 |
...
| 選股欄位-常用 | FOFTEN.md | 23 | 月營收、主力買賣超張數、本益比、成交金額(億)、成交量、收盤價、均價、每股稅後淨利(元) …共23項 |
...
| 其他-搜尋API補遺 | RESTMISC.md | 6 | 撮合狀態、暫緩撮合狀態、試搓成交價、試搓成交日期、試搓成交時間、試搓成交量 |
| 屬性欄位-商品資訊欄位(GetSymbolInfo) | ATTRFIELD.md | 33 | ETD、交易單位、交易幣別、交易所、先買現沖、即將處置結束股、可放空、可轉換日 …共33項 |

總計 1663 項。查特定函數/欄位：先 grep 本目錄 `^## 名稱`，再 Read 該檔對應段落。