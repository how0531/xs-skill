...
涵蓋五大腳本類別：**指標**、**交易（自動交易/當沖/波段）**、**警示（策略雷達）**、**選股（選股中心）**、**函數**。內含完整撰寫規範、26 條常見錯誤對照、**622 個 xstrader 實戰場景索引**、179+216 函數分類速查、報價 132+資料 500+選股 400+ 三大欄位字典。
...
└── references/
    ...
    ├── anti-patterns.md                     ← **錯誤對照**：26 條常見錯誤 wrong → right（含營收年增率/負債總額正名、變數命名片段衝突）
