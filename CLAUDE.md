...
| `references/xshelp/DIGEST.md` | 全量精讀摘要（485 條限制/陷阱） | 由精讀代理批次生成；小幅修正可手改，大改建議重跑精讀流程 |
...
- `XScript_Preset` 系統腳本原始碼在 **GitHub**（官方 <https://github.com/sysjust-xq/XScript_Preset>），
